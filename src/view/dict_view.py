...
class DictView:
    ...
    async def post_word_info(self, ctx, pos_contexts, button_view):
    ...
    async def edit_word_info(self, pos_context, context_num, contexts_count, interaction):
    ...
    def set_phonetics(self, pos_contexts):
        phonetics = []
